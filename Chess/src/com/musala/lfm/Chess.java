...
public class Chess extends JFrame implements MouseListener, MouseMotionListener {
 ...
 layeredPane = new JLayeredPane();
  ...
  JLabel piece = new JLabel( new ImageIcon("p5.png") );
  JPanel panel = (JPanel)chessBoard.getComponent(0);
  panel.add(piece);
  piece = new JLabel(new ImageIcon("p3.png"));
  panel = (JPanel)chessBoard.getComponent(1);
  panel.add(piece);
  piece = new JLabel(new ImageIcon("p3.png"));
  panel = (JPanel)chessBoard.getComponent(2);
  panel.add(piece);
  piece = new JLabel(new ImageIcon("p4.png"));
  panel = (JPanel)chessBoard.getComponent(2);
  panel.add(piece);
  piece = new JLabel(new ImageIcon("kral.png"));
  panel = (JPanel)chessBoard.getComponent(3);
  panel.add(piece);
  piece = new JLabel(new ImageIcon("p2.png"));
  ...
  panel.add(piece);
  piece = new JLabel(new ImageIcon("p5.png"));
  panel = (JPanel)chessBoard.getComponent(7);
  panel.add(piece);
  piece = new JLabel(new ImageIcon("piun.png"));
